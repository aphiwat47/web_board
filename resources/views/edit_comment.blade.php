...
<div class="container">
    <!-- <div class="row justify-content-center"> -->
        <!-- <div class="col-md-8"> -->
            <div class="card">
                    <div class="card-header" style="background-color: #73B9D7; color: white;" align="center" ><h3><b>{{ __('Edit Comment ') }}</b></h3></div>
                        <div class="container"  style="background-color: #9DE6E8;">
                        @foreach($comment as $comment)
                        @endforeach
                            <form method='POST' action="{{ route('comment.update',$comment->id_comment) }}" enctype="multipart/form-data"><br>
                                @csrf
                                @method("PUT")
                                @error('comment')
                                    <div class="my-2">
