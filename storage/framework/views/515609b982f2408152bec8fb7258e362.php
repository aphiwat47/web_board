...
<div class="container">
    <div align='right'>
        <a class='btn btn-dark' href = "<?php echo e(route ('home.search')); ?>" style=" width: 35%; color: white;"><b>
    ...
    <div class="card">
         <!-- <div class="card-header" style="background-color: #4B527E; color: white; " align="center" ><h3><b><?php echo e(__('Kratooh By Group-1')); ?></b></h3> -->
         ...
         <h3><b>
            ...
            <div class="card-body" style="background-color: #FDF0F0; color: white; "><b>
                ...
                <?php endif; ?>
                <?php if($message = Session::get('errorpath')): ?>
                ...
                <?php if(isset($error)): ?>
                    <h3 style="color:red;"><b>*** Please add complete personal information on the Profile page. ***
                        <a class="btn btn-danger" style="color:white;" href="<?php echo e(route('profile.show',Auth::user()->id)); ?>" ><b>Click Here</b><a/>
                    </h3>
                <?php endif; ?>
                ...
                <div align="right">
                    <a class='btn btn-dark btn-md' style="background-color: #001C30;" href = "<?php echo e(route('post.create')); ?>"><b>
                    Create New Kratooh
