                ...
                <!--<div class="card-header"><?php echo e(__('Create Post')); ?></div>-->
                    <div class="container" style="background-color: #FFADAD; color: white;" align="center" >
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <form method='POST' action="<?php echo e(route('ad.update.post',$post1->id_post)); ?>" enctype="multipart/form-data"><br>
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/myProject/resources/views/admin/ad_edit_post.blade.php ENDPATH**/ ?>