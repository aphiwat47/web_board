...
<div class="container">
            <div class="card">
                <div class="card-header" style="background-color: #974EC3; color: white; " align="center" ><h5><b><?php echo e(__('Admin search ')); ?>
                ...
                <div class="card">
                    ...
                    <div class="card">
                        ...
                        <p align="center"><b> Search through the user id</b></p><hr>
                            <form action="<?php echo e(route('admin.search')); ?>" method="GET" align="center">
                                ...
                                <tbody>
                                    ...
                                    <th style="text-align:center" scope="row" width="40"><b><?php echo e($i++); ?></b></th>
                                        ...
                                        <td style="text-align:center">
                                            <a class='btn btn-outline-primary btn-md' style="color: black;" href="<?php echo e(route('manage.profile', $user->id)); ?>"><b>Data</b></a>
                                        </td>
                    ...
                    <?php if($posts != '[]'): ?>
                        ...
                        <div class="card">
                            <div class="position-relative">
                                ...
                                <div>
                                <a class='btn btn-primary btn-md' style=" width: 100%; color: white;" href = "<?php echo e(route ('ad.manage.comm',$post->id_post)); ?>">
                                    <b>Manage Comment</b>
                                </a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/myProject/resources/views/admin/admin_search.blade.php ENDPATH**/ ?>