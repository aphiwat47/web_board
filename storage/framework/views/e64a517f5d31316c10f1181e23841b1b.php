...
<div class="container">
            <div class="card">
                <div class="card-header" align="center" style="background-color: #7C81AD; width: 100%; color: white;""><h5><b><?php echo e(__('Register')); ?></b></div>
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email" placeholder="test@go.buu.ac.th">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end"><b><?php echo e(__('Confirm Password :')); ?></b></label>
